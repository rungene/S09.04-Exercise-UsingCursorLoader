...
//  TODO (17) Create constant int values representing each column name's position above
    ...
    //we store the indices of the values in the array pf strings above to more quickly be able
   //to access the data fromour query.if the order of the strings above changes, these indices
    //must be adjusted to match the order of strings
